...
class _BlaLocationPickerState extends State<BlaLocationPicker> {
  ...
  Future<List<Location>> fetchAllLocations() async {
    LocationRepository locationRepository = context.read<LocationRepository>();
    availableLocations = await locationRepository.getAvailableLocation();
    return availableLocations;
  }

  List<Location> get filteredLocation {
    // call the fetch location function
    fetchAllLocations();
